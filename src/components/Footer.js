...
const Footer = () => {
  return (
    <div className='wrapper'>
        ...
        {/* <h2 className="f2 tc lh-title tracked text-white text-center">Follow</h2> */}
        <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://smarturl.it/HERfb?IQid=site" target="_blank" rel="noreferrer" title="Facebook">
        ...
        <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://www.youtube.com/channel/UCFwC3Ryue6CorFm2xCEG0Aw" target="_blank" rel="noreferrer" title="youtube">
          ...
          <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://smarturl.it/HERig?IQid=site" target="_blank" rel="noreferrer" title="Instagram">
          ...
          <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://soundcloud.com/iamhermusic" target="_blank" rel="noreferrer" title="SoundCloud">
          ...
          <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://smarturl.it/HERtw?IQid=site" target="_blank" rel="noreferrer" title="Twitter">
          ...
          <div className='app__social'>
              <p className='text-white'>@2022 Aaliyah</p>
            </div>
          <div className='app__social'>
          <a href="https://www.linkedin.com/in/aaliyah-symlar-931213102/"  target="_blank" rel="noreferrer"><BsLinkedin /></a>
              &nbsp;
              <a href="https://www.instagram.com/aaliyahsymlar/" target="_blank" rel="noreferrer">
                <BsInstagram />
              </a>
          </div>
    </footer>
